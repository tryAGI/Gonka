...
namespace Gonka
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Gonka.AutoSDKRetryOptions Retry { get; set; } = new global::Gonka.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Gonka.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Gonka.IAutoSDKHook>();
        ...
        public global::Gonka.AutoSDKClientOptions AddHook(
            global::Gonka.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Gonka.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Gonka.AutoSDKClientOptions UseAuthorizationProvider(
            global::Gonka.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Gonka.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Gonka.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Gonka.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Gonka.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Gonka.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Gonka.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Gonka.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Gonka.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Gonka.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Gonka.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Gonka.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Gonka.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Gonka.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Gonka.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Gonka.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Gonka.AutoSDKClientOptions clientOptions,
            global::Gonka.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Gonka.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Gonka.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Gonka.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Gonka.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Gonka.IAutoSDKHook, global::Gonka.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Gonka.AutoSDKHookContext context)
        {
