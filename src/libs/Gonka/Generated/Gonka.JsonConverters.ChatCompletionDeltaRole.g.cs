...
{
    /// <inheritdoc />
    public sealed class ChatCompletionDeltaRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Gonka.ChatCompletionDeltaRole>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::Gonka.ChatCompletionDeltaRoleExtensions.ToValueString(value));
        }
    }
}
