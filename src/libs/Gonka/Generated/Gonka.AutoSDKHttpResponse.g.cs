...
namespace Gonka
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Gonka.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Gonka.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Gonka.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Gonka.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Gonka.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Gonka.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Gonka.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Gonka.ApiException exception)
        ...
        private static global::Gonka.AutoSDKRequestOptions CloneRequestOptions(
            global::Gonka.AutoSDKRequestOptions? source)
        {
            var clone = new global::Gonka.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
